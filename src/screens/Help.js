...
function Help() {
	...
	return (
		<div>
			<Line number='6' backgroundColor='#858585' />
			...
			<h4 onClick={handleSix} className='six'>
				6
				<div
					style={{ background: selectionColor.six }}
					className='squareSix'
				></div>
				<div
					style={{ background: selectionColor.six }}
					className='squareSix2'
				>
					{' '}
				</div>
				<div
					style={{ background: selectionColor.six }}
					className='squareSix3'
				></div>
				<div
					style={{ background: selectionColor.six }}
					className='squareSix4'
				></div>
				<div
					style={{ background: selectionColor.six }}
					className='squareSix5'
				></div>
				<div
					style={{ background: selectionColor.six }}
					className='squareSix6'
				></div>
			</h4>
			<h4 onClick={handleSeven} className='seven'>
				7
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven'
				></div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven2'
				>
					{' '}
				</div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven3'
				></div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven4'
				></div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven5'
				></div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven6'
				></div>
				<div
					style={{ background: selectionColor.seven }}
					className='squareSeven7'
				></div>
			</h4>
			<h4 onClick={handleEight} className='eight'>
				8
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight2'
				>
					{' '}
				</div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight3'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight4'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight5'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight6'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight7'
				></div>
				<div
					style={{ background: selectionColor.eight }}
					className='squareEight8'
				></div>
			</h4>
			<h4 onClick={handleNine} className='nine'>
				9
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine2'
				>
					{' '}
				</div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine3'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine4'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine5'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine6'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine7'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine8'
				></div>
				<div
					style={{ background: selectionColor.nine }}
					className='squareNine9'
				></div>
			</h4>
			<h4 onClick={handleTen} className='ten'>
				10
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen2'
				>
					{' '}
				</div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen3'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen4'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen5'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen6'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen7'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen8'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen9'
				></div>
				<div
					style={{ background: selectionColor.ten }}
					className='squareTen10'
				></div>
			</h4>
